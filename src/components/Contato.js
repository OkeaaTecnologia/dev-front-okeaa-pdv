...
class Contato extends React.Component {
    ...
    atualizaContato = (id) => {
        ...
        // fetch(`https://dev-api-okeaa-pdv.azurewebsites.net/api/v1/contato/${id}`, {
        fetch(`http://localhost:8080/api/v1/contato/${id}`, {
    ...
    cadastraContato = (xmlContato) => {
        ...
        return fetch("http://localhost:8080/api/v1/cadastrarcontato", {
    ...
    atualizarContato = (xmlContato) => {
        ...
        return fetch('http://localhost:8080/api/v1/atualizarcontato/' + id, {
            method: 'PUT',
            body: stringXml,
            headers: {
                'Content-Type': 'application/xml'
